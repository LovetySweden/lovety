    ...
    const activities = [
      {
        ...
        description: "Tjuvstarta helgen med att lära känna nya intressanta personer på denna roliga lunch med faciliterat singel-mingel!\n\nBeskrivning\nVåra mingel luncher är för dig som vill lära känna människor i en avslappnad gruppmiljö utan krav på att “klicka” med en specifik person. \nVarje lunch är centrerad runt ett eget tema, vilket ger deltagarna ett naturligt sätt att lära känna varandra och öppnar upp för intressanta samtal. \n\nOavsett om du aktivt letar efter en partner, nya vänner eller meningsfulla möten kan detta bli höjdpunkten på din vecka.\n\nLunch är inkluderad i biljettpriset.\n\nSå här går det till\nVi ses i entren till Orangeriet där en Lovety värd möter upp. Värden guidar sedan dig och övriga deltagare igenom lunchen och tillhandahåller samtalsprompter och ser till att alla har någon att prata med och att allt flyter på på ett trevlig och lättsamt sätt.\n\nUnder lunchen får du tillfälle att både umgås i grupp och individuella samtal. \n\nÄr det färre än 6 deltagare ställer vi in och då betalas hela biljettpriset tillbaka.",
      ...
      },
      {
        ...
        description: "Vill du träffa nya människor på ett avslappnat sätt? Kom och måla, skapa och fika tillsammans – en mysig stund fylld av kreativitet, skratt och meningsfulla möten.\n\nVi faciliterar samtalen och ser till att du alltid har en samtalspartner. Lite som speedating fast med ett element av skapande.\n\nBeskrivning\nVåra kreativa träffar är för dig som vill lära känna människor i en kreativ gruppmiljö samtidigt som du låter fantasin flöda och skapar något personligt. Under varje träff skapar vi ett nytt alster, vilket leder till naturliga samtal och ett lättsamt sätt att lära känna varandra. Inga förkunskaper krävs, här är alla konstnärer oavsett tidigare erfarenhet och fokus är på att ha en trevlig stund tillsammans.\n\nOavsett om du aktivt letar efter en partner, nya vänner eller meningsfulla möten kan detta bli höjdpunkten på din vecka.\n\nAllt material är inkluderat i biljettpriset.\n\nSå här går det till\nVi ses <insert plats> där en Lovety värd möter upp. Värden guidar sedan dig och övriga deltagare igenom aktiviteten och tillhandahåller samtalsprompter och ser till att alla har någon att prata med och att allt flyter på på ett trevlig sätt.\n\nÄr det färre än 6 deltagare ställer vi in och då betalas hela biljettpriset tillbaka.",
        price: "TBD",
        earlyBirdPrice: "TBD",
